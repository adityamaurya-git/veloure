...
document.querySelector(".product-list").addEventListener("mouseenter",(dets)=>{
  gsap.to(".cursor", {
...
document.querySelector(".product-list").addEventListener("mouseleave",()=>{
  gsap.to(".cursor", {
